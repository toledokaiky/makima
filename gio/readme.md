...
|--------|------------------|
| Observação (Conta e campanha) [Duas vezes ao dia, 5h e 13h] | Analisar se CTR, CPA, CPC e outras metris as estão dentro do desvio padrão ou estão disparadas para cima ou para baixo (comparado com os ultimos 7 dias).
